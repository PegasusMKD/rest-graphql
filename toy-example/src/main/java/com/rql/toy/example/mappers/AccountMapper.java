...
public interface AccountMapper {
	...
	@Mapping(target = "friends", expression = "java(properties.contains(\"friends\") ? INSTANCE.rqlToAccountDtos(entity.getFriends(), currentPath, propertyNodes, properties, \"friends\") : null)")
